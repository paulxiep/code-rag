...
**Label:** post_r0_rr | **Date:** 2026-06-08T14:24:12.052121500+00:00 | **Commit:** bbc5805 | **Model:** BGESmallENV15_384
**Completed tracks:** r0
...
| implementation | 29 | 0.57 | 0.65 | 0.65 | 62% |
| overview | 28 | 0.67 | 0.78 | 0.87 | 75% |
| relationship | 19 | 0.44 | 0.53 | 0.53 | 53% |

## Failures (recall@5 = 0)

| ID | Query | Expected | Got |
|----|-------|----------|-----|
| hero-chat-endpoint | "How does the chat endpoint work?" | handlers.rs, chat | code:send_chat (0%), code:S3BlobStore (0%), code:PromptMessages (0%) |
...
| rel-language-implementations | "What languages are supported for parsing?" | languages/mod.rs, handler_for_path | code:LanguageHandler (91%), readme:invoice-parse/README.md (7%), file:code-rag/crates/code-rag-ingest/src/ingestion/languages/python.rs (6%) |
