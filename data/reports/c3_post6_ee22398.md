...
**Label:** c3_post6 | **Date:** 2026-04-09T10:19:06.089116400+00:00 | **Commit:** ee22398 | **Model:** BGESmallENV15_384
...
| b4-comp-retriever-api | "Compare retriever.rs vs standalone_api.rs" | retriever.rs, standalone_api.rs | code:standalone_app (100%), code:matches_file (100%), code:pre_classify_comparison (96%) |
| b4-comp-shared-py-rs | "What is the difference between shared-py and shared-rs?" | libs/shared-py, shared-py | code:is_lib_rs (100%), code:AppState (100%), code:matches_file (96%) |
| b4-comp-ingestion-processing | "Differences between the ingestion and processing services" | services/processing, processing | code:IngestionResult (100%), code:IngestionStats (96%), code:run_full_ingestion (92%) |
| b4-comp-storage-types | "What is the difference between the storage and types crates?" | types | code:reconcile_crates (100%), code:search_crates (96%), code:embed_and_store_crates (96%) |
