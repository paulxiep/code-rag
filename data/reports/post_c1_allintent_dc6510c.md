...
**Label:** post_c1_allintent | **Date:** 2026-04-09T03:02:25.795430800+00:00 | **Commit:** dc6510c | **Model:** BGESmallENV15_384
**Completed tracks:** c1
...
| b4-comp-retriever-api | "Compare retriever.rs vs standalone_api.rs" | retriever.rs, standalone_api.rs | code:evaluate_hits (85%), code:matches_file (66%), code:api_base_url (64%) |
| b4-comp-sim-agents | "How does sim-core differ from agents?" | crates/sim-core, crates/agents, sim-core, agents | code:bollinger_traders (85%), code:default (85%), code:macd_traders (85%) |
