...
**Label:** c3_post5 | **Date:** 2026-04-09T10:14:02.109887800+00:00 | **Commit:** ee22398 | **Model:** BGESmallENV15_384
...
| comp-retriever-generator | "Compare the retriever and generator" | retriever.rs | crate:code-rag-types (57%), crate:quant-trading-gym (57%), module_doc:src (57%) |
...
| b4-comp-python-rust-qtg | "How does the Python training pipeline differ from the Rust simulation?" | quant-trading-gym/python | module_doc:src (66%), readme:invoice-parse/README.md (64%), module_doc:src (64%) |
