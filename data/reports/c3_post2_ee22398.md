...
**Label:** c3_post2 | **Date:** 2026-04-09T09:58:18.113418600+00:00 | **Commit:** ee22398 | **Model:** BGESmallENV15_384
...
| comp-retriever-generator | "Compare the retriever and generator" | retriever.rs, generator.rs | code:from (100%), code:from (95%), code:GenerationCostMetrics (90%) |
...
| b4-comp-retriever-api | "Compare retriever.rs vs standalone_api.rs" | retriever.rs, standalone_api.rs | code:matches_file (100%), code:api_base_url (95%), code:standalone_app (90%) |
| b4-comp-shared-py-rs | "What is the difference between shared-py and shared-rs?" | libs/shared-py, shared-py | code:PythonHandler (100%), code:is_lib_rs (95%), code:extensions (90%) |
| b4-comp-ingestion-processing | "Differences between the ingestion and processing services" | services/processing, processing | code:IngestionResult (100%), code:IngestionStats (95%), code:run_ingestion (90%) |
| b4-comp-python-rust-qtg | "How does the Python training pipeline differ from the Rust simulation?" | quant-trading-gym/python, quant-trading-gym/src | code:pre_classify_comparison (100%), code:batches_to_crate_chunks_hybrid (95%), module_doc:src (66%) |
| b4-comp-storage-types | "What is the difference between the storage and types crates?" | types | code:embed_and_store_crates (100%), code:reconcile_crates (95%), code:CrateChunk (90%) |
