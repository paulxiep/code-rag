...
**Label:** c3_post | **Date:** 2026-04-09T09:53:33.443821800+00:00 | **Commit:** ee22398 | **Model:** BGESmallENV15_384
...
| comp-retriever-generator | "Compare the retriever and generator" | retriever.rs, generator.rs | crate:code-rag-types (57%), crate:quant-trading-gym (57%), module_doc:src (57%) |
| comp-rust-python-handler | "How do the Rust and Python language handlers differ?" | rust.rs, RustHandler | crate:output (61%), crate:code-rag-engine (61%), crate:code-rag-types (61%) |
| comp-embed-vs-search | "What is the difference between embedding and vector search?" | embedder.rs | module_doc:src (59%), readme:invoice-parse/README.md (58%), module_doc:src (57%) |
...
| b4-comp-retriever-api | "Compare retriever.rs vs standalone_api.rs" | retriever.rs, standalone_api.rs | crate:output (63%), crate:shared-rs (61%), crate:ingestion (61%) |
| b4-comp-python-rust-qtg | "How does the Python training pipeline differ from the Rust simulation?" | quant-trading-gym/python, quant-trading-gym/src | module_doc:src (66%), readme:invoice-parse/README.md (64%), module_doc:src (64%) |
...
- Expected file 'quant-trading-gym/python' referenced in test cases but never found in any results
...
- Expected file 'quant-trading-gym/src' referenced in test cases but never found in any results
