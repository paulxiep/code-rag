...
**Label:** c3_post3 | **Date:** 2026-04-09T10:02:22.976985500+00:00 | **Commit:** ee22398 | **Model:** BGESmallENV15_384
...
| comp-retriever-generator | "Compare the retriever and generator" | retriever.rs, generator.rs | code:from (61%), code:from (61%), code:GenerationCostMetrics (61%) |
...
| b4-comp-python-rust-qtg | "How does the Python training pipeline differ from the Rust simulation?" | quant-trading-gym/python, quant-trading-gym/src | code:pre_classify_comparison (69%), module_doc:src (66%), code:batches_to_crate_chunks_hybrid (66%) |
