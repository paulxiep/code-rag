...
**Label:** post_r3 | **Date:** 2026-06-09T15:52:36.400679800+00:00 | **Commit:** a70614c | **Model:** BGESmallENV15_384
...
|--------|---------|----------|-----------|-------------|------------|
| comparison | 13 | 0.62 | 0.69 | 0.75 | 100% |
| implementation | 29 | 0.64 | 0.68 | 0.69 | 62% |
| overview | 33 | 0.68 | 0.77 | 0.84 | 67% |
| relationship | 21 | 0.49 | 0.60 | 0.60 | 48% |
...
| rel-what-calls-retrieve | "What calls the retrieve function?" | handlers.rs | cluster:code-rag#cluster13 (18%), file:code-rag/crates/code-rag-core/src/retriever.rs (0%), code:to_retrieved_items (0%) |
...
| rel-language-implementations | "What languages are supported for parsing?" | handler_for_path | code:LanguageHandler (91%), readme:invoice-parse/README.md (7%), code:CodeAnalyzer (1%) |
...
| b5-sig-query | "Functions that return Result<T, Error>" | retriever.rs, retrieve | code:fetchJson (100%), code:pack_result (86%), code:check_status (76%) |
| b5-body-query | "Which function parses JSON configs?" | from_json_str | code:LoadConfig (98%), code:_parse_candidate_json (88%), code:writeJson (87%) |
